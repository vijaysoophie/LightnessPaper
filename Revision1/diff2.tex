...
%DIF ADD Revision1.tex   Fri Sep 14 12:03:14 2018
\usepackage{graphicx}
...
). Another issue, not addressed by these datasets, is }\DIFaddend relative frequency of different \DIFdelbegin \DIFdel{reflectance spectra }\DIFdelend \DIFaddbegin \DIFadd{surface reflectivities }\DIFaddend in natural viewing. \DIFdelbegin \DIFdel{In addition, }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
