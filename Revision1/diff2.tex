...
%DIF ADD Revision1.tex   Sat Sep  8 10:05:55 2018
\usepackage{graphicx}
...
The LRF }\DIFaddend is a measure of the overall amount of light reflected by a surface \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{astm1121477}}%DIFAUXCMD
.
Estimating the LRV from a }\DIFdelend \DIFaddbegin \DIFadd{luminance of the reference illuminant itself}\footnote{\DIFadd{LRF is related to albedo, but the concept of albedo does not incorporate the human luminosity function.}} \DIFadd{\mbox{%DIFAUXCMD
\cite{astm1121477}}%DIFAUXCMD
.
...
The package builds on the RenderToolbox4 package (\href{http://rendertoolbox.org}{http://rendertoolbox.org}\DIFdelbegin \DIFdel{) \mbox{%DIFAUXCMD
\cite{heasly2014rendertoolbox3}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{; \mbox{%DIFAUXCMD
\citeNP{heasly2014rendertoolbox3}}%DIFAUXCMD
)}\DIFaddend ,
...
\DIFaddbegin \DIFadd{The AMA analysis package is available at: }\href{https://github.com/vijaysoophie/LuminanceConstancyAmaAnalysis}{LuminanceConstancyAmaAnalysis}\DIFadd{.
}\DIFaddend 
