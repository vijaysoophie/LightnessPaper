...
We define the computational problem of luminance constancy as that of estimating the light reflectance value (LRV) of a target object's surface reflectance function\footnote{We distinguish luminance constancy and LRV from lightness constancy and albedo, respectively, as the latter terms refer to achromatic stimuli.}.
The LRV is a measure of the overall amount of light reflected by a surface \cite{astm1121477}.
Defining the LRV from a surface reflectance function requires two steps.
...
of the illumination.
Similarly, while the scenes rendered for this work were matte, 
...
These include variation in non-spectral properties of objects and lighting in the scene, including object texture, material, specularity, and shape as well as lighting geometry. 
