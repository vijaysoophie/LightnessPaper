...
\author{Singh}{Vijay}
 ...
 {}
 {Department of sychology, University of Pennsylvania, PA, USA}
...
Here we express LRVs as proportions, so that they take on values between 0.0 and 1.0. An LRV of 0.0 means that none of the light from the reference illuminant is reflected from the surface. An LRV of 1.0 means that all of the light from the reference illuminant is reflected from the surface.
