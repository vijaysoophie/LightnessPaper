...
The LRV is a measure of the overall amount of light reflected by a surface \DIFdelbegin \DIFdel{\cite{astm1121477}.
Estimating }\DIFdelend \DIFaddbegin \DIFadd{reflectance of the reference illuminant itself}\footnote{\DIFadd{LRV is related to albedo, but the concept of albedo does not incorporate the human luminosity function. It is also related to Munsell Value, but Munsell Value is defined with respect to a somewhat obsolete standard illuminant (CIE Illuminant C).}} \DIFadd{\cite{astm1121477}.
...
\DIFaddbegin \DIFadd{A similar approach has been used previously to study the perception of lightness and specularity \cite{toscani2013optimal,wiebel2015statistical,toscani2017lightness}; our work adds to this approach through the addition of variation in color. 
