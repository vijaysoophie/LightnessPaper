...
The perceived color of an object has important behavioral implications, since color helps us to identify objects and their properties (REF Jacobs, Mollon).
%@article{RN11757,
%   author = {Mollon, J. D.},
...
The challenge of object color perception is that this reflected light depends not just on the intrinsic properties of the object (e.g., its surface reflectance)
Indeed, the light reflected from an object depends not just on the object's surface reflectance, but also on extrinsic factors such as the illumination, the object's pose,
...
The ability of a visual system to extract such a stable representation is called color constancy. Although human color constancy is by no means perfect, it is often very good (REFS: Foster, Brainard and Radonjic). 
%@article{RN13987,
%   author = {Foster, D. H.},
...
%http://ac.els-cdn.com/S0042698910004402/1-s2.0-S0042698910004402-main.pdf?_tid=9f194810-0789-11e4-8bf9-00000aab0f26&acdnat=1404925019_749d71db2edf9d07b6323195f5a519dc},
%   year = {2011},
%   type = {Journal Article}
%}
%@inbook{RN14002,
%   author = {Brainard, D. H. and Radonji?, A.},
%   title = {Color constancy},
...
%   type = {Journal Article}
%}
Subsequent computational constancy work sought to generalize both the image formation model to include richer geometric descriptions and to incorporate probabilistic descriptions of the statistics of naturally occurring scenes (REFS Funt and Drew; D'Zmura and Iverson; D'Zmura, Iverson, and Singer; Barron and Malik; Brainard and Freeman; LET'S SEE IF WE CAN FIND SOME RECENT REVIEWS).
%@inproceedings{RN3265,
%   author = {Funt, B. V. and Drew, M. S.},
...
% NEED TO SAY SOMETHING ABOUT THE LITERATURE ON COMP. COLOR CONSTANCY
% NEED TO MOTIVATE WHAT WE'RE GOING TO DO.  SUPERVISED LEARNING APPROACH USING VIRTUAL WORLD DATA TO GET LABELLED TRAINING DATA.

% IN THIS PAPER, WILL APPLY OUR APPROACH TO A REDUCED VERSION OF THE PROBLEM, AS A FIRST STEP
