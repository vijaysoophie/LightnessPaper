...
\end{figure}
% Axis labels: Normalized Irradiance, Wavelength (nm), CIE x chromaticity, CIE y chromaticity.  In caption, make sure a, b, c are right.  Add titles on a, b: Granada Data, Statistical Model
...
\end{figure}
% Axis labels etc as with illumination
...
\end{figure}
% Y axis label LRV.  x axis, maybe "Example Number"  Expand caption.
...
% Add in Nicolas REFS on some details.
