...
Figure~\ref{fig:illuminantSpectra} plots the measurements in normalized form (red) to make apparent the variation in the relative spectra. The spectra are normalized by their mean over wavelength.
...
Figure~\ref{fig:illuminantSpectra} also illustrates the relative spectra of draws obtained using this procedure (black).
