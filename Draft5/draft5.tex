...
perceived LRV of an object. 
To do this, we have developed a software that renders naturalistic multispectral images of 3D scenes with 
...
\begin{subfigure}{0.4 \textwidth}
    ...
    \end{subfigure}
    \label{introFigure}
    \caption{{\bf Color and luminance constancy:} (a)  The light reflected from an object to the eye depends both on the surface reflectance of the object and on the illumination. 
Additionally, the reflected light also depends on geometric factors, such as the object's shape, pose, and position. 
The human visual system is able to account for variations in the reflected light due to object-extrinsic factors and produce a percept of object color that is relatively stable across such variations, an ability called color constancy. 
(b) Images of a sphere under a fixed illuminant.  
Down each column, the reflectance function of the sphere varies only by a scale factor; the shape of the reflectance spectrum is held fixed.  
The shape of the reflectance spectrum varies across each row.
Within each row, the light reflectance value (LRV) of the spheres is constant. 
The values on the left of each row provide the corresponding LRV. 
...
\begin{figure}
    ...
    \centering
        ...
        \includegraphics[width=\textwidth]{../FiguresDraft5/Figure4/Figure4_d.png}
...
\centering
    ...
    \centering
        ...
        \includegraphics[width=\textwidth]{../FiguresDraft5/Figure4/Figure4_a.png}
    ...
    \centering
        ...
        \includegraphics[width=\textwidth]{../FiguresDraft5/Figure4/Figure4_c.png}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{../FiguresDraft5/FigureRMSEVsN/Figure14.pdf}
\caption{{\bf Variation of relative RMSE with number of RFs and size of training set:} (a) Variation of relative RMSE for Condition 3 as the size of training set. The relative RMSE converges around 2000 images. (b) Variation of relative RMSE v/s the number of receptive fields used in estimation. The performance converges around 6 Rfs}
 \label{fig:barGraphs}
\end{figure}
...
% % VS: To ensure that secondary reflections were switched off, I checked that the multispectral values of the central patch of the rendered image and the corresponding cone isoemrizations were the same for images that were generated with the same target and illuminant but different backgrounds. Then I performed the training and test as usual.
