...
\title{Luminance constancy in naturalistic scenes}
...
We generated three distinct datasets, which we refer to as Conditions 1-3. These are describe below.
...
The LRV values were equally spaced between 0.2 and 0.6. For each LRV value, we generated a different target surface reflectance spectrum for each scene. Thus, for each target object LRV value, the relative reflectance spectrum of the target object could differ.
