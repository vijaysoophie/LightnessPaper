...
%% VS: The results are similar for both cost function. MSE estimates are biased at the ends.
%% VS: For case 1 and 2, the first two RFs contain all the information and the performance is based on these two RFs.
