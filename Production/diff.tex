...
%DIF DEL Revision1.tex    Tue Sep 18 14:21:14 2018
%DIF ADD Production.tex   Wed Oct 24 12:02:44 2018
\usepackage{graphicx}
...
\author{Singh}{Vijay}
 ...
 {Neuroscience Graduate Group\DIFaddbegin \DIFadd{, Bioengineering Graduate Group}\DIFaddend }
 {Department of Psychology, University of Pennsylvania, PA, USA}
 {}{jburge@psych.upenn.edu}

%DIF < % Possible reviewers:
 %DIF < 
 %DIF <   Tom Serre, Brown
 %DIF <   Bill Freeman, Google Research
 %DIF <   Roland Fleming, Geissen
 %DIF <   Kavita Bala, Cornell
\DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \keywords{color constancy, luminance constancy, supervised learning}
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.4 \textwidth}
%DIFDELCMD < 	\centering
%DIFDELCMD < 	%%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
        ...
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure1/Figure1_a.png}
%DIFDELCMD <         %DIFDELCMD < \label{fig:introSchematic}%%%
...
{%DIFAUXCMD
        ...
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure1/Figure1_b.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:introExampleFigure}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     %DIFDELCMD < \label{introFigure}%%%
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{Figure1.eps}    
...
The LRF is a measure of the overall amount of light reflected by a surface relative to the reference illuminant itself\DIFdelbegin \footnote{\DIFdel{LRF is related to albedo, but the concept of albedo does not incorporate the human luminosity function.}} %DIFAUXCMD
\addtocounter{footnote}{-1}%DIFAUXCMD
\DIFdel{\mbox{%DIFAUXCMD
\cite{astm1121477}}%DIFAUXCMD
.}\DIFdelend \DIFaddbegin \DIFadd{.}\footnote{\DIFadd{LRF is related to albedo, but the concept of albedo does not incorporate the human luminosity function. The terminology surrounding LRF and the related concept light reflectance value (LRV) varies somewhat in the literature. Here we follow the definition of LRF given by the \mbox{%DIFAUXCMD
\citeNP{astm1121477}}%DIFAUXCMD
.}}
\DIFaddend Obtaining the LRF from a known surface reflectance function requires two steps.
...
\DIFdelFL{Library }}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure2/Figure2_a.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:baseSceneLibrary}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     %%%
\DIFdelFL{~
...
\DIFdelFL{Mill}}    
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure2/Figure2_b.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:baseSceneMill}%%%
%DIFDELCMD <     \end{subfigure}    
%DIFDELCMD <     %%%
\DIFdelFL{~
    }%DIFDELCMD < \begin{subfigure}[b]{0.22 \textwidth}
...
\DIFdelFL{Table-Chairs}}    
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure2/Figure2_c.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:baseSceneTableChairs}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     %%%
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \begin{subfigure}[b]{0.14 \textwidth}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Big-ball}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure3/Figure3_a.png}
%DIFDELCMD <         %DIFDELCMD < \label{fig:libraryWithBigBall}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <      %%%
\DIFdelFL{~ 
    }%DIFDELCMD < \begin{subfigure}[b]{0.14 \textwidth}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Xylophone}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure3/Figure3_b.png}
%DIFDELCMD <         %DIFDELCMD < \label{fig:libraryWithXylophone}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <      %%%
\DIFdelFL{~ 
    }%DIFDELCMD < \begin{subfigure}[b]{0.14 \textwidth}
...
\DIFdelFL{Barrel}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure3/Figure3_c.png}
%DIFDELCMD <         %DIFDELCMD < \label{fig:libraryWithBarrel}%%%
%DIFDELCMD <          \end{subfigure}
%DIFDELCMD <     %%%
\DIFdelFL{~
	}%DIFDELCMD < \begin{subfigure}[b]{0.14 \textwidth}
...
\DIFdelFL{Ring toy}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure3/Figure3_d.png}
%DIFDELCMD <         %DIFDELCMD < \label{fig:libraryWithRingToy}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <         %%%
\DIFdelFL{~
    	}%DIFDELCMD < \begin{subfigure}[b]{0.14 \textwidth}
...
\DIFdelFL{Bottle}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure3/Figure3_e.png}
%DIFDELCMD <         %DIFDELCMD < \label{fig:libraryWithChampagneBottle}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD < %%%
...
\DIFaddend % Figure 4
\begin{figure}
\DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.18 \textwidth}
%DIFDELCMD <     \centering
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Target position}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure4/Figure4_a.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:targetPositionVariation}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     %%%
\DIFdelFL{~
	}%DIFDELCMD < \begin{subfigure}{0.18 \textwidth}
%DIFDELCMD <     \centering
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Target size/pose}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure4/Figure4_b.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:targetSizeOrientation}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD < %%%
\DIFdelFL{~
}%DIFDELCMD < \centering
...
\DIFdelFL{Target spectra}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure4/Figure4_c.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:targetVariation}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     %%%
\DIFdelFL{~
    }%DIFDELCMD < \begin{subfigure}{0.18 \textwidth}
...
\DIFdelFL{Illumination spectra}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure4/Figure4_d.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:illuminationVariation}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <           %%%
\DIFdelFL{~  
    }%DIFDELCMD < \begin{subfigure}{0.18 \textwidth}
...
\DIFdelFL{Background spectra}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure4/Figure4_e.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:backGroundVariation}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD < 

%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{Figure4.eps}
...
\begin{figure}
\centering   
\DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.33 \textwidth}
%DIFDELCMD < 		%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{Figure5.eps}        
    \DIFaddendFL \caption{\DIFaddbeginFL {\bf \DIFaddFL{Conditions 1-3:}} \DIFaddFL{Illustrative images for the three types of spectral variations studied in this paper. (a) }\DIFaddendFL Condition 1\DIFaddbeginFL \DIFaddFL{: variable target object relative reflectance spectrum, fixed light source spectra, fixed background object spectra (same as Fig.~\ref{fig:introFigure}b). 
(b) Condition 2: variable target object relative reflectance spectrum, variable light source spectra, fixed background object spectra. (c) Condition 3: variable target object relative reflectance spectrum, variable light source spectra, variable background object spectra. The spheres in each row of each panel have the same LRF, while the spheres in each column of each panel have the same relative surface reflectance spectrum.  Across panels a-c, spheres in corresponding locations have the same surface reflectance. In all three panels, the overall light source spectra scale factors (see }\nameref{Methods}\DIFaddFL{) were drawn from a uniform distribution on the range }[\DIFaddFL{0.5, 1.5}]\DIFaddFL{. This is smaller than the variation we studied, but allows us to show the variation within the dynamic range available for display in publication. All images in this figure are rendered with common scaling and tone mapping.}\DIFaddendFL } 
%DIF < 		\includegraphics[width=\textwidth]{../FiguresDraft5/Figure2/Figure2_a.png}
		\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure1/Figure1_b.pdf}
%DIFDELCMD <  		%DIFDELCMD < \label{fig:backgroundVarying}%%%
%DIFDELCMD < 	\end{subfigure}
%DIFDELCMD < 	\begin{subfigure}{0.33 \textwidth}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Condition 2}}	
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure5/Figure5_b.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:targetIlluminantVarying}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD < 	\begin{subfigure}{0.33 \textwidth}
%DIFDELCMD < 	%%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Condition 3}}	
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure5/Figure5_c.pdf}        
%DIFDELCMD <         %DIFDELCMD < \label{fig:allSpectraVarying}%%%
%DIFDELCMD <     \end{subfigure}    
%DIFDELCMD <     %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < {\bf %%%
\DIFdelFL{Conditions 1-3:}%DIFDELCMD < } %%%
...
(b) Condition 2: variable target object relative reflectance spectrum, variable light source spectra, fixed background object spectra. (c) Condition 3: variable target object relative reflectance spectrum, variable light source spectra, variable background object spectra. The spheres in each row of each panel have the same LRF, while the spheres in each column of each panel have the same relative surface reflectance spectrum.  Across panels a-c, spheres in corresponding locations have the same surface reflectance. In all three panels, the overall light source spectra scale factors (see }%DIFDELCMD < \nameref{Methods}%%%
\DIFdelFL{) were drawn from a uniform distribution on the range }%DIFDELCMD < [%%%
\DIFdelFL{0.5, 1.5}%DIFDELCMD < ]%%%
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \begin{subfigure}[b]{0.24 \textwidth}
%DIFDELCMD <     \centering
%DIFDELCMD < 	%%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Granada dataset}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure6/Figure6_a.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:granadaData}%%%
%DIFDELCMD <     \end{subfigure}
...
\DIFdelFL{Statistical model}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure6/Figure6_b.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:illuminantSamples}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <       	\begin{subfigure}[b]{0.24 \textwidth}
%DIFDELCMD <     \centering
%DIFDELCMD <         %%%
...
\DIFdelFL{CIE xy chromaticity}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure6/Figure6_c.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:xyDiagram}%%%
%DIFDELCMD <         \end{subfigure}
%DIFDELCMD <       	\begin{subfigure}[b]{0.24 \textwidth}
%DIFDELCMD <     \centering
%DIFDELCMD <         %%%
...
\DIFdelFL{Color swatches}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure6/Figure6_d.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:sRGBIlluminant}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{Figure6.eps}
...
\begin{figure}
\centering
    \DIFdelbeginFL %DIFDELCMD < \begin{subfigure}{0.24 \textwidth}
%DIFDELCMD <     \centering
%DIFDELCMD <             %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Munsell and Vrhel dataset}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure7/Figure7_a.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:reflectanceSpectra}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     \begin{subfigure}{0.24 \textwidth}
%DIFDELCMD <     \centering
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Statistical model}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure7/Figure7_b.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:reflectanceSamples}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     \begin{subfigure}{0.24 \textwidth}
%DIFDELCMD <     \centering
%DIFDELCMD <     %%%
...
\DIFdelFL{CIE xy chromaticity}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure7/Figure7_c.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:xyChroReflectance}%%%
%DIFDELCMD <     \end{subfigure}    
%DIFDELCMD <     \centering
%DIFDELCMD < 	\begin{subfigure}{0.24 \textwidth}
%DIFDELCMD <     \centering
...
\DIFdelFL{Color swatches}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure7/Figure7_d.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:backgroundSwatches}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     %%%
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{../FiguresDraft5/Figure8/Figure8.pdf}
%DIFDELCMD < %%%
...
\begin{figure}
\centering
    \DIFdelbeginFL %DIFDELCMD < \begin{subfigure}[b]{0.25 \textwidth}
%DIFDELCMD < 		\centering
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{sRGB rendering of a 3D scene}}
                %DIFAUXCMD
%DIFDELCMD < \vspace{1.2mm}
%DIFDELCMD <         \includegraphics[width=\textwidth]{../FiguresDraft5/Figure9/Figure9_a.png}
%DIFDELCMD <         %DIFDELCMD < \label{fig:3DScene}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     %%%
\DIFdelFL{~ 
    }%DIFDELCMD < \begin{subfigure}[b]{0.19 \textwidth}   
%DIFDELCMD <     %%%
...
\DIFdelFL{Cropped image}}
        %DIFAUXCMD
%DIFDELCMD < \vspace{2.5mm}
%DIFDELCMD <         \includegraphics[width=\textwidth]{../FiguresDraft5/Figure9/Figure9_b.png}
%DIFDELCMD <         %DIFDELCMD < \label{fig:croppedImage}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     %%%
\DIFdelFL{~ 
    }%DIFDELCMD < \begin{subfigure}[b]{0.19 \textwidth}
...
\DIFdelFL{Retinal image}}
        %DIFAUXCMD
%DIFDELCMD < \vspace{2.5mm}
%DIFDELCMD <         \includegraphics[width=\textwidth]{../FiguresDraft5/Figure9/Figure9_c.png}
%DIFDELCMD <         %DIFDELCMD < \label{fig:croppedImageWithMosaic}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     %%%
\DIFdelFL{~
    }%DIFDELCMD < \begin{subfigure}[b]{0.205 \textwidth}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Normalized cone contrast}}        
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth]{../FiguresDraft5/Figure9/Figure9_d.png}
%DIFDELCMD <         %DIFDELCMD < \label{fig:coneContrast}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{Figure9.eps}
...
We modeled a visual system having typical optical blurring (including axial chromatic aberration, \citeNP{marimont1994matching}), and typical spatial sampling with an interleaved rectangular mosaic of long (L), middle (M)  and short (S) wavelength-sensitive cones (\citeNP{brainard2015color}; Fig.~\DIFdelbegin \DIFdel{\ref{fig:croppedImageWithMosaic}}\DIFdelend \DIFaddbegin \DIFadd{\ref{fig:figure9}c}\DIFaddend ). 
...
%DIF < % Details on ISETBIO computations from Nicolas (TEXT IN CAPS IS FROM VIJAY)
%DIF < % Scene: 
%DIF < %- the default mean luminance was set to 200, but there is a key-value param that could have overridden this value. 
%DIF < %  I do not know if this were the case.
%DIF < %
%DIF < % % MEAN LUMINANCE = 0, NO SCALING
%DIF < 
%DIF < %- The default FOV was 1 deg, but there is a key-value param that could have overridden this value.
%DIF < %  I do not know if this were the case.
%DIF < %
%DIF < % % HORIZONTAL FOV = 1
%DIF < %
%DIF < %- Distance default is 1 meter, but there is  a key-value param that could have overridden this value.
%DIF < %  I do not know if this were the case.
%DIF < %
%DIF < %% DISTANCE 1M
%DIF < %
%DIF < %Optics: 
%DIF < %- 3 mm pupil, 17 mm focal length, with a spectro-spatial OTF described in  
%DIF < %  (Marimont & Wandell (1994) J. Opt. Soc. Amer. A,  v. 11, p. 3113-3122), 
%DIF < %   which includes axial chromatic aberration. However, there is key-value param o skip the OTF. 
%DIF < %   Not sure if this was used.  It it was used, the optics was set to diffraction limited.
%DIF < %
%DIF < % % SKIP OTF OFF:  'skipOTF', false ...  
%DIF < %
%DIF < %Lens: 
%DIF < %- not sure if the optical density is from Wyszecki&Stiles or from Stockman-Sharpe. 
%DIF < %  The isetbio file commend only says it is from PTB. David do you know, or should I check
%DIF < %  the data?
%DIF < %
%DIF < %Cone Mosaic: 
%DIF < %- rectangular cone mosaic with 0.6:0.3:0.1 LMS densities
%DIF < %- FOV was a key-value param, so I do not know what was used.
%DIF < %- Also the mosaic was subsampled  according to a cone-stride param, with a default of 15 cones
%DIF < %but there is a key-value param that could have overridden this value. I do not know what that parameter value was.
%DIF < %
%DIF < % CONE STRIDE = 3 'coneStride', 3, ... 
%DIF < %
%DIF < %
%DIF < %- There is a key-value pair to also low-pass the optical image with default value to not do so.
%DIF < %  If that was user-overridden the OI was lowpass filtered using a Gaussian whose sigma was dependent on the cone-stride param.
%DIF < %
%DIF < % LOW PASS FILTER = MATCH CONE STRIDE : lowPassFilter = 'matchConeStride';      
%DIF < %
%DIF < %- IntegrationTime was not specified, so it was the default which is 5 msec (note VS subsequently changed to 100 msec).
%DIF < %  The cone isomerization maps were also demosaiced using linear interpolation.
%DIF < %- The default isomerization noise was set to none, but there is a key-value parameter
%DIF < %  that can override it. I do not know what the value of that was.
%DIF < %
%DIF < % ISOMERIZATION NOISE = FROZEN, 'isomerizationNoise', 'frozen'
%DIF < %
%DIF < %-  Finally, there is a key-value param named 'coneEfficiencyBasedReponseScaling', which by default is set to 'none'
%DIF < %   But if it was user-set to non 'none' the code scaled the responses to simulate equal quantal efficiencies 
%DIF < %   for L , M and S coneEfficiencyBasedReponseScaling by undoing filtering by the lens and the macular pigment.
%DIF < %   I do not know if this was used.
%DIF < % 
%DIF < % coneEfficiencyBasedReponseScaling = 'area'
\DIFdelbegin %DIFDELCMD < 
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \begin{subfigure}[b]{0.3 \textwidth}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics{Figure10.eps}
    \DIFaddendFL \caption{\DIFaddbeginFL {\bf \DIFaddFL{Condition 1 results:}} \DIFaddFL{(a) Mean estimated }\DIFaddendFL LRF \DIFdelbeginFL \DIFdelFL{estimates}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\pm$ 1 standard deviation for images in the test set obtained using the AMA-based estimator and linear regression on the cone excitations. Solid lines show the mean estimate, the filled region in lighter color shows $\pm$ 1 standard deviation. The diagonal identity line (dotted black) indicates veridical estimation. The filled regions representing standard deviations are too small to be visible. Relative RMSE (see Methods: Quantifying estimation performance) is 0.7\% for linear regression and 1.1\%  for AMA-based estimation. (b) Training image cone excitations in Condition 1 projected onto the first two AMA receptive fields. Each cluster of responses represents the image patches associated with a particular LRF. The response clusters are approximated by a multivariate Gaussians whose means and covariances are represented by the ellipses shown in the figure. (c) The first three AMA receptive fields. These are specified over the same 1 x 1 degree patch as the stimuli.}\DIFaddendFL }
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth, trim={0 0 0 1.3cm},clip]{../FiguresDraft5/Figure10/Figure10_a.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:case1Estimates}%%%
%DIFDELCMD <     \end{subfigure} 
%DIFDELCMD <         \begin{subfigure}[b]{0.31 \textwidth}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{RF responses}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth, trim={0 3mm 0 15mm},clip]{../FiguresDraft5/Figure10/Figure10_b.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:case1RFResponse}%%%
%DIFDELCMD <     \end{subfigure}
...
\DIFdelFL{AMA receptive fields}}
	%DIFAUXCMD
%DIFDELCMD < \includegraphics[width=1.0\textwidth, trim={0.2cm -0.cm 0 0.3cm}]{../FiguresDraft5/Figure10/Figure10_c.pdf}
%DIFDELCMD < 	%DIFDELCMD < \label{fig:case1RFs}%%%
%DIFDELCMD <     \end{subfigure}   
%DIFDELCMD <     %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < {\bf %%%
\DIFdelFL{Condition 1 results:}%DIFDELCMD < } %%%
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \centering{LRF estimates} \newline\centering{(Excitations)}%%%
}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth, trim={0 0 0 1.5cm},clip]{../FiguresDraft5/Figure11/Figure11_a.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:case2IsomerizationEstimates}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <         \begin{subfigure}[b]{0.22 \textwidth}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \centering{RF responses} \newline\centering{(Excitations)}%%%
}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth, trim={0 0 0 1.5cm},clip]{../FiguresDraft5/Figure11/Figure11_b.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:case2RFResponseIsomer}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <             \begin{subfigure}[b]{0.22 \textwidth}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
...
%DIFDELCMD < \centering{LRF estimates}  \newline \centering{(Normalized contrast)}%%%
        ...
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth, trim={0 0 0 1.5cm},clip]{../FiguresDraft5/Figure11/Figure11_c.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:case2ContrastEstimates}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <             \begin{subfigure}[b]{0.22 \textwidth}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
...
%DIFDELCMD < \centering{RF responses}  \newline \centering{(Normalized contrast)}%%%
        ...
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth, trim={0 0 0 1.5cm},clip]{../FiguresDraft5/Figure11/Figure11_d.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:case2RFResponseContrast}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     %%%
\DIFdelendFL %DIF >     \begin{subfigure}[b]{0.22\textwidth}   
%DIF >         \caption{\centering{LRF estimates} \newline\centering{(Excitations)}}
%DIF >         \includegraphics[width=\textwidth, trim={0 0 0 1.5cm},clip]{../FiguresDraft5/Figure11/Figure11_a.pdf}
%DIF >         \label{fig:case2IsomerizationEstimates}
%DIF >     \end{subfigure}
%DIF >         \begin{subfigure}[b]{0.22 \textwidth}
%DIF >         \caption{\centering{RF responses} \newline\centering{(Excitations)}}
%DIF >         \includegraphics[width=\textwidth, trim={0 0 0 1.5cm},clip]{../FiguresDraft5/Figure11/Figure11_b.pdf}
%DIF >         \label{fig:case2RFResponseIsomer}
%DIF >     \end{subfigure}
%DIF >             \begin{subfigure}[b]{0.22 \textwidth}
%DIF >         \caption{\centering{LRF estimates}  \newline \centering{(Normalized contrast)}}
%DIF >         \includegraphics[width=\textwidth, trim={0 0 0 1.5cm},clip]{../FiguresDraft5/Figure11/Figure11_c.pdf}
%DIF >         \label{fig:case2ContrastEstimates}
%DIF >     \end{subfigure}
%DIF >             \begin{subfigure}[b]{0.22 \textwidth}
%DIF >         \caption{\centering{RF responses}  \newline \centering{(Normalized contrast)}}
%DIF >         \includegraphics[width=\textwidth, trim={0 0 0 1.5cm},clip]{../FiguresDraft5/Figure11/Figure11_d.pdf}
%DIF >         \label{fig:case2RFResponseContrast}
%DIF >     \end{subfigure}
\DIFaddbeginFL \includegraphics{Figure11.eps}
...
\DIFdelFL{LRF estimates}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth, trim={0 0 0 1.3cm},clip]{../FiguresDraft5/Figure12/Figure12_a.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:case3Estimates}%%%
%DIFDELCMD <     \end{subfigure} 
%DIFDELCMD <         \begin{subfigure}[b]{0.31\textwidth}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
...
\DIFdelFL{Receptive field response}}
        %DIFAUXCMD
%DIFDELCMD < \includegraphics[width=\textwidth, trim={0 3mm 0 15mm},clip]{../FiguresDraft5/Figure12/Figure12_b.pdf}
%DIFDELCMD <         %DIFDELCMD < \label{fig:case3RFResponse}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     \begin{subfigure}[b]{0.32 \textwidth}
%DIFDELCMD < 	%%%
%DIFDELCMD < \caption{%
...
\DIFdelFL{AMA receptive fields}}
	%DIFAUXCMD
%DIFDELCMD < \includegraphics[width=1.0\textwidth, trim={0.2cm -0.cm 0 0.3cm}]{../FiguresDraft5/Figure12/Figure12_c.pdf}
%DIFDELCMD < 	%DIFDELCMD < \label{fig:case3RFs}%%%
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     %%%
\DIFdelendFL %DIF > \begin{subfigure}[b]{0.3 \textwidth}
%DIF >         \caption{LRF estimates}
%DIF >         \includegraphics[width=\textwidth, trim={0 0 0 1.3cm},clip]{../FiguresDraft5/Figure12/Figure12_a.pdf}
%DIF >         \label{fig:case3Estimates}
%DIF >     \end{subfigure} 
%DIF >         \begin{subfigure}[b]{0.31\textwidth}
%DIF >         \caption{Receptive field response}
%DIF >         \includegraphics[width=\textwidth, trim={0 3mm 0 15mm},clip]{../FiguresDraft5/Figure12/Figure12_b.pdf}
%DIF >         \label{fig:case3RFResponse}
%DIF >     \end{subfigure}
%DIF >     \begin{subfigure}[b]{0.32 \textwidth}
%DIF > 	\caption{AMA receptive fields}
%DIF > 	\includegraphics[width=1.0\textwidth, trim={0.2cm -0.cm 0 0.3cm}]{../FiguresDraft5/Figure12/Figure12_c.pdf}
%DIF > 	\label{fig:case3RFs}
%DIF >     \end{subfigure}
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.6\textwidth]{../FiguresDraft5/Figure13/Figure13.pdf}
%DIFDELCMD < %%%
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{../FiguresDraft5/Figure14/Figure14.pdf}
%DIFDELCMD < %%%
