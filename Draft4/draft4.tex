...
%LET'S SEE IF WE CAN FIND SOME RECENT REVIEWS).
...
%% DHB: The ASTM citation is not formatting well.  It should give a year.
...
%% DHB: Need to fix up citations in this paragraph. The URLs for RTB and Mitsuba should be inside the same paraneheses as the citations that
% follow.
...
%		\includegraphics[width=\textwidth]{../FiguresDraft4/Figure2/Figure2_a.png}
    ...
    \end{subfigure}    
    \caption{{\bf Illustration of Conditions 1-3:} sRGB renderings of illustrative images from the datasets for Conditions 1, 2 and 3. The numbers on the left indicate the standard luminance level of the target object. 5 images are shown at each luminance level. We studied three types of spectral variations. (a) Condition 1: target object relative surface reflectance spectrum variable, light source spectra fixed, background object spectra fixed (same as Fig.~\ref{fig:introExampleFigure}).
