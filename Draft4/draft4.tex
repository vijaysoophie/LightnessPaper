...
We quantified overall performance in terms of overall relative root mean squared estimation error (relative RMSE) for the test set. The relative RMSE is the square root of the mean of the squared difference between the estimated and true LRV divided by the true LRV. The mean is taken over all stimuli in the test set.
%\begin{align}
