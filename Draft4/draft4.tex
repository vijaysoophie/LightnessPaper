...
\centering
    ...
    \end{subfigure} 
        \begin{subfigure}[b]{0.26 \textwidth}
        \caption{Receptive field response}
        \includegraphics[width=\textwidth, trim={0 3mm 0 15mm},clip]{../FiguresDraft4/Figure10/Figure10_d.pdf}
        \label{fig:case1RFResponse}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.28 \textwidth}
...
\centering
    ...
    \end{subfigure} 
        \begin{subfigure}[b]{0.26\textwidth}
        \caption{Receptive field response}
        \includegraphics[width=\textwidth, trim={0 3mm 0 15mm},clip]{../FiguresDraft4/Figure12/Figure12_d.pdf}
        \label{fig:case3RFResponse}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.28 \textwidth}
...
We quantified overall performance in terms of overall relative root mean squared estimation error (relative RMSE) for the test set.
If $\hat{Y}$ is the estimated LRV and $Y$ is the true LRV, the relative RMSE is ($E_{\rm rel}$) defined as $E_{\rm rel} = \sqrt{\left\langle\left((\hat{Y}-Y)/Y\right)^2\right\rangle}$,
