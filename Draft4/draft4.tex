...
\end{figure}
%% DHB: The labels above each panel wrap in unfortunate ways. Fix.
...
Figure~\ref{fig:Condition2}a and b show the results when we learned and evaluated the performance of AMA on the cone excitations.
Performance is poor.
...
In Condition 1, where only the relative target object spectrum varies, luminance constancy poses an easy computationsl problem,
