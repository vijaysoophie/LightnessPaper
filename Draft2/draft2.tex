...
We define the computational problem of luminance constancy as that of estimating the luminous reflectance factor of the diffuse component of an object's surface reflectance function.
The luminous reflectance factor is a measure of the overall amount of light reflected by a matte surface.
More precisely, the luminous reflectance factor is the normalized luminance of the light that would
be reflected to the eye from a flat matte object with that the specified surface reflectance function, when the object is diffusely illuminated by a reference illuminant.
The normalization factor is 100 divided by the luminance of the reference illuminant, so that luminous reflectance factors range between 0 and 100.
