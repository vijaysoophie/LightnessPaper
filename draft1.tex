...
\begin{subfigure}[b]{0.25 \textwidth}
    ...
    \begin{subfigure}[b]{0.19 \textwidth}
    \hspace{0.1 \textwidth}
        \includegraphics[width=\textwidth]{Figure3/croppedImageWithMosaic.png}
        \caption{Optical Image}
        \label{fig:croppedImageWithMosaic}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.2 \textwidth}
        \includegraphics[width=\textwidth]{Figure3/coneContrast.png}
...
\begin{subfigure}[b]{0.3 \textwidth}
		\centering
        \includegraphics[width=\textwidth]{Figure8/case9AcrossCaseComparisonSVD.pdf}
    ...
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.3 \textwidth}   
        \includegraphics[width=\textwidth]{Figure8/case10AcrossCaseComparisonSVD.pdf}
    ...
    %(or a blank line to force the subfigure onto a new line)
        \begin{subfigure}[b]{0.3 \textwidth}
        \includegraphics[width=\textwidth]{Figure8/case12AcrossCaseComparisonSVD.pdf}
...
\begin{subfigure}[b]{0.3 \textwidth}
		\centering
        \includegraphics[width=\textwidth]{Figure9/case9AcrossCaseComparisonAMA.pdf}
    ...
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.3 \textwidth}   
        \includegraphics[width=\textwidth]{Figure9/case10AcrossCaseComparisonAMA.pdf}
    ...
    %(or a blank line to force the subfigure onto a new line)
        \begin{subfigure}[b]{0.3 \textwidth}
        \includegraphics[width=\textwidth]{Figure9/case12AcrossCaseComparisonAMA.pdf}
...
\begin{subfigure}[b]{0.22 \textwidth}
        \includegraphics[width=\textwidth]{Figure11/baseSceneLibrary.png}
        \caption{Library }
    ...
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.22 \textwidth}
        \includegraphics[width=\textwidth]{Figure11/baseSceneMill.png}
        \caption{Mill}
    ...
    %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.22 \textwidth}
        \includegraphics[width=\textwidth]{Figure11/baseSceneTableChairs.png}
        \caption{Table-Chairs}
        \label{fig:baseSceneTableChairs}
    \end{subfigure}
    
    \begin{subfigure}[b]{0.22 \textwidth}
        \includegraphics[width=\textwidth]{Figure11/baseSceneIndoorPlant.png}
        \caption{Indoor-plant}
        \label{fig:baseSceneIndoorPlant}
    \end{subfigure}    
    ~
    \begin{subfigure}[b]{0.22 \textwidth}
        \includegraphics[width=\textwidth]{Figure11/baseSceneWarehouse.png}
        \caption{Warehouse}
...
\begin{figure}
    ...
    \centering
        \includegraphics[width=\textwidth]{Figure13/targetVariation.png}
    ...
    \begin{subfigure}[b]{0.18 \textwidth}
    \centering
        \includegraphics[width=\textwidth]{Figure13/backgroundVariation.png}
    ...
    \begin{subfigure}[b]{0.18 \textwidth}
    \centering
        \includegraphics[width=\textwidth]{Figure13/illuminationVariation.png}
	...
	\begin{subfigure}[b]{0.18 \textwidth}
    \centering
        \includegraphics[width=\textwidth]{Figure13/targetPosition.png}
	...
	\begin{subfigure}[b]{0.18 \textwidth}
    \centering
        \includegraphics[width=\textwidth]{Figure13/targetSizeOrientation.png}
